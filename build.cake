...
Task ("Version")
    .Does (() => {
        ...
        var file = "./Sources/Facade.Template.Instance/AssemlyInfo.cs";
        CreateAssemblyInfo(file, new AssemblyInfoSettings {
            Title = "Facade.Template",
            Version = version,
            FileVersion = version,
...
Task ("Publish")
    ...
    .Does (() => {
        ...
        DotNetCorePublish("./Sources/Facade.Template.Instance/Facade.Template.Instance.csproj", settings);
